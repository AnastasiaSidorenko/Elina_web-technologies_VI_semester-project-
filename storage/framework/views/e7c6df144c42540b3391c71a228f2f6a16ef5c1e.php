            ...
            <div class="card">
                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/admin/register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            <label for="name" class="col-md-4 control-label"><?php echo e(trans('admin.name')); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            <label for="email" class="col-md-4 control-label"><?php echo e(trans('admin.email')); ?></label>
                    ...
                    <div class="form-group<?php echo e($errors->has('role') ? ' has-error' : ''); ?>">
                        <label for="role" class="col-md-4 control-label"><?php echo e(trans('admin.role')); ?></label>

                        <div class="col-md-6">
                            <input id="role" type="text" class="form-control" name="role" value="<?php echo e(old('role')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                            <label for="password-confirm" class="col-md-4 control-label"><?php echo e(trans('register.confirm_password')); ?></label>
...
<?php /* /home/nastya/www/elina/resources/views/admin/auth/register.blade.php */ ?>